/*
 Programming Principles and Practice in C++, 2nd ed. Chapter 7  Exercise 2
Allow '=' operator to reassign variables.
Problem this raises is that modifying Statment to check whether a name Token is followed by '='
would require adding the ability to putback 2 tokens.
Instead, I put redefinition of variables inside primary()
/*
...
double primary()
{
    ...
    case name:
    {
        ...
        if (next_token.kind == '=')
        {
            if (!is_declared(t.name)) error ("Can't alter value of undeclared variable");
